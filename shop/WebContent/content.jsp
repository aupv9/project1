                ...
                <div class="content-top">
                    ...
                    <div class="content-top-in">
                        <div class="col-md-3 md-col">
                            <div class="col-md">
                                <a href="single.html"><img  src="images/f4.png" alt="" /></a>	
                                <div class="top-content">
                                    <h5><a href="single.html">Head Phone</a></h5>
                                    <div class="white">
                        ...
                        <div class="col-md-3 md-col">
                            <div class="col-md">
                                <a href="single.html"><img  src="images/f3.png" alt="" />	</a>
                                <div class="top-content">
                                    <h5><a href="single.html"></a></h5>
                                    <div class="white">
                                        <a href="single.html" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
                                        <p class="dollar"><span class="in-dollar">$</span><span>30</span></p>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>							
                            </div>
                        ...
                        <div class="col-md-3 md-col">
                            <div class="col-md">
                                <a href="single.html"><img  src="images/f2.png" alt="" /></a>	
                                <div class="top-content">
                                    <h5><a href="single.html"></a></h5>
                                    <div class="white">
                                        <a href="single.html" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
                                        <p class="dollar"><span class="in-dollar">$</span><span>50</span></p>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>							
                            </div>
                        ...
                        <div class="col-md-3 md-col">
                            <div class="col-md">
                                <a href="single.html"><img  src="images/f1.png" alt="" /></a>	
                                <div class="top-content">
                                    <h5><a href="single.html"></a></h5>
                                    <div class="white">
                                        <a href="single.html" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
                                        <p class="dollar"><span class="in-dollar">$</span><span>45</span></p>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>							
                            </div>
