...
<html>
    ...
    <body>
        ...
        <!--header-->
        <div class="header">
            <div class="header-top" style="background:#1a0dab;">
                <div class="container">	
                                        ...
                                        <div class="shopping_cart">
                                            ...
                                            <div class="cart_box">
                                                <div class="message">
                                                    ...
                                                    <div class="list_desc"><h4><a href="CartSVL?command=remove&productID=<%=list.getValue().getProduct().getProductID()%>"><%=list.getValue().getProduct().getProductName()%></a></h4>
                    ...
                    <div class="h_menu4">
                        ...
                        <ul class="nav">
                            <li class="active"><a href="index.jsp"><i> </i>Home</a></li>
                             ...
                             <%
                                        for (Category c : categoryDAO.getListCategory()) {                          //Các category được lấy từ csdl lên 
                                        		
                                    %>	
                            <li><a href="product.jsp?category=<%=c.getCategoryID()%>" style="color: black;"><%=c.getCategoryName()%></a>
